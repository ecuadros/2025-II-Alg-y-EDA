...
public: // Metodos para acceder a hijos y padre
...
protected:
                                  ...
                                  Node* pParent, Node*& rpOrigin)
    {
        ...
        Node* child = static_cast<Node*>(rpOrigin->getChild(branch));
        rpOrigin->getChildRef(branch) = internal_insert(elem, ref, rpOrigin, child);
        return rpOrigin;
    }
public:
